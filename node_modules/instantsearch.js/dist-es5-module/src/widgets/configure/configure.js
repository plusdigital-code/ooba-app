...
var _connectConfigure = require('../../connectors/configure/connectConfigure.js');
...
function configure(searchParameters) {
  try {
    ...
    var makeWidget = (0, _connectConfigure2.default)();
    return makeWidget({ searchParameters: searchParameters });
  } catch (e) {
