(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/router'), require('formiojs'), require('lodash'), require('lodash/each'), require('lodash/intersection')) :
    typeof define === 'function' && define.amd ? define('angularFormio', ['exports', '@angular/core', '@angular/router', 'formiojs', 'lodash', 'lodash/each', 'lodash/intersection'], factory) :
    (global = global || self, factory(global['angular-formio'] = {}, global.core, global.router, global.formiojs, global.lodash, global._each, global._intersection));
}(this, function (exports, core, router, formiojs, lodash, _each, _intersection) { 'use strict';
